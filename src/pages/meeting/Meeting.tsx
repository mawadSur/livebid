    ...
    const handleBroadcastedMessage = ({
      ...
      switch (type) {
        ...
        case "new-bid": {
          ...
          if (parseFloat(payload.bid) > highestBid.bid)
            setHighestBid({
              bid: payload.bid,
              user: payload.user,
            });
  ...
  return (
    <div className="meeting-container">
        ...
        {auctionStarted && (
          <div
            className={`auction-container ${
              !showPopup ? "hide-auction-popup" : ""
            }`}
          >
            <img className="auction-img" src={bidItems[item].link} />
            <div className="auction-desc">{bidItems[item].description}</div>
            <AuctionControlBar
              item={item}
      ...
      <div className="meeting-controlbar">
        ...
        <DyteLeaveButton size="md" onClick={() => handleLeave()} />
